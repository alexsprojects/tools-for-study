# For this one, I recommend Python support in Visual Studio (however plain old Python works best.)
# You can and should cut and paste everything in this file, including what is the stated above and below.
# Original code by KpaBap
